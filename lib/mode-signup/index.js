...
SignupPanel.prototype.submit = function() {
  ...
  widget.$auth0.signup({
    ...
    if (!err && widget.options.signupAutoLogin) return widget._signinWithAuth0(panel);
    if (!err && 'function' === typeof callback) return callback.apply(widget, arguments), widget.hide();
