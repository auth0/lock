...
SignupPanel.prototype.bindAll = function() {
  ...
  var showSignupAction = (signinOptions.disableSignupAction !== true) && ((connection && connection.showSignup) || signinOptions.signupLink);


  var list = self.query('.a0-iconlist').html('');

  // hide only and only if set to false
  this.query('.a0-options').toggleClass('a0-hide', !showSignupAction);
