...
SMSPanel.prototype.renderAndBindSubmitCodeTemplate = function () {
  this.widget._setTitle(this.options.i18n.t('sms:passcode:title'));
...
SMSPanel.prototype.onsendsmssubmit = function(e) {
  ...
  if (!phone_valid) {
    widget._showError(this.options.i18n.t('sms:phone:invalidNumber'));
    widget._focusError(phone_input);
    return;
  }
...
SMSPanel.prototype.onsmscodesubmit = function(e) {
  ...
  if (!code_valid) {
    widget._showError(this.options.i18n.t('sms:passcode:invalidCode'));
    widget._focusError(code_input);
    return;
  }
...
SMSPanel.prototype.oncountrycodeselectorclick = function (e) {
  ...
  // Clean error container
  this.widget._showError();
  this.widget._focusError();
  ...
  // hide footer and header title
  this.widget.query('.a0-footer').toggleClass('a0-hide', true)
  this.widget.header.toggleTitle(false);
};
...
SMSPanel.prototype.oncountrycodesearch = function (e) {
  ...
  var search = this.query('[name="search-code"]').val().toLowerCase();
...
SMSPanel.prototype.oncountrycodechange = function (e) {
  ...
  // restore footer and header title
  this.widget.query('.a0-footer').toggleClass('a0-hide', !this.options._isFreeSubscription())
  this.widget.header.toggleTitle(true);
