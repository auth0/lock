...
var template = require('./sms.ejs');
var smsTemplate = require('./sms-sender.ejs');
var smsCodeTemplate = require('./sms-code-sender.ejs');
...
PasswordlessPanel.prototype.renderAndBindSMS = function () {
  ...
  var sms = this.widget.render(smsTemplate, {
    countryCodes: countryCodes,
    selectedCountryCode: this.countryCode()
  });
  
  form.empty().append(sms);
...
PasswordlessPanel.prototype.renderAndBindSMSCode = function () {
  ...
  var form = this.query('form');
  var smsCode = this.widget.render(smsCodeTemplate, {
    countryCode: this.countryCode(),
    phoneNumber: this.phoneNumber()
  });

  form.empty().append(smsCode);
