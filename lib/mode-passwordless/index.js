...
PasswordlessPanel.prototype.countryCode = function(countryCode) {
  ...
  } else if ('undefined' === typeof this.options.countryCode) {
    // set default country code
    this.options.countryCode = countryCodes[0].DialCode;
  }
 ...
 * @private
 */
PasswordlessPanel.prototype.renderAndBindSendSMSTemplate = function () {  
 ...
 * @private
 */
PasswordlessPanel.prototype.renderAndBindSubmitSMSCodeTemplate = function () {
...
PasswordlessPanel.prototype.bindAll = function() {
  this.renderAndBindSendSMSTemplate();
};
...
PasswordlessPanel.prototype.onsendsmssubmit = function(e) {
  ...
  if (!phone_valid) {
    widget._showError(this.options.i18n.t('passwordless:invalidPhoneNumber'));
    widget._focusError(phone_input);
    return;
  }
  ...
  widget._requestSMSCode(this, function (err /*, result */ ) {
    ...
    panel.renderAndBindSubmitSMSCodeTemplate();
  });
};
...
PasswordlessPanel.prototype.onsmscodesubmit = function(e) {
  ...
  if (!code_valid) {
    widget._showError(this.options.i18n.t('passwordless:invalidSmsCode'));
    widget._focusError(code_input);
    return;
  }

  // All validations passed, submitting
  panel.options.smsCode = code_value;
