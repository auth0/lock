...
SigninPanel.prototype.bindAll = function() {
  ...
  var locals = {
    showSignup: (widget.displayOptions.showSignup !== false) && ((auth0Conn && auth0Conn.showSignup) || widget.displayOptions.signupLink),
    showForgot: (widget.displayOptions.showForgot !== false) && ((auth0Conn && auth0Conn.showForgot) || widget.displayOptions.forgotLink),
