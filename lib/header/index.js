...
/**
 * Toggle widget's h1 to show or hide
 *
 * @param {Boolean} toggle
 * @private
 */

HeaderView.prototype.toggleTitle = function(toggle) {
  var $h1 = this.query('h1');
  var status = $h1.hasClass('a0-hide');
  var change = null != toggle ? !!toggle : !status;
  $h1.toggleClass('a0-hide', change);
};
/**
