...
ResetPanel.prototype.bindAll = function() {
  ...
  var showResetAction = (signinOptions.disableResetAction !== true) && ((connection && connection.showForgot) || signinOptions.signupLink);;

  // hide only and only if set to false
  this.query('.a0-options').toggleClass('a0-hide', !showResetAction);
