...
function OptionsManager(widget, options) {
  ...
  this.responseType = null !== options.responseType
  ...
  this.rememberLastLogin = null != options.rememberLastLogin
    ...
    : true;
  this.integratedWindowsLogin = null != options.integratedWindowsLogin
    ? options.integratedWindowsLogin
    : true;
  ...
  this.closable = null != options.closable
    ? options.closable
    : !this.container;
...
OptionsManager.prototype._useBigSocialButtons = function() {
  return null != this.socialBigButtons
    ?  this.socialBigButtons
    : !this._isThereAnyEnterpriseOrDbConnection();
}
...
function strategiesConnectionsMapper(connections) {
  return function (strategy) {
    ...
    var strategy = _.extend({}, strategy);
