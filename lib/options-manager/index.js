...
OptionsManager.prototype._useBigSocialButtons = function() {
  return this.socialBigButtons ?  this.socialBigButtons : !this._isThereAnyEnterpriseOrDbConnection();
};
...
OptionsManager.prototype._focusDisabled = function() {
  return this.focusInput ? !this.focusInput : small_screen() || !!this.container;
};
