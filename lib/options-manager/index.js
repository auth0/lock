...
var authParams = require('./auth-params');
...
function OptionsManager(widget, options) {
  ...
  this.$auth0._callbackOnLocationHash = 'token' === options.responseType || !!this.$auth0._callbackOnLocationHash;
  ...
  this.responseType = options.responseType ? options.responseType : 'code'; 

  // enable/disable last login and AD discovery
  this.rememberLastLogin = options.rememberLastLogin ? options.rememberLastLogin : true;
  this.integratedWindowsLogin = options.integratedWindowsLogin ? options.integratedWindowsLogin : true;
  ...
  this.closable = options.closable ? options.closable : !this.container;
...
OptionsManager.prototype._getAuth0Connection = function(username) {
  ...
  if (this.defaultUserPasswordConnection) {
...
OptionsManager.prototype._useBigSocialButtons = function() {
  return this.socialBigButtons !== undefined ?  this.socialBigButtons : !this._isThereAnyEnterpriseOrDbConnection();
};
...
OptionsManager.prototype._focusDisabled = function() {
  return this.focusInput !== undefined ? !this.focusInput : small_screen() || !!this.container;
};
