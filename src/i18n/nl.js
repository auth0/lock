export default {
  error: {
    forgotPassword: {
      "too_many_requests": "U heeft het limiet van wachtwoord aanpassings pogingen bereikt. Wacht even voor dat u het nog een keer probeert.",
    ...
    login: {
      ...
      "invalid_user_password": "Verkeerde inloggegevens.",
      "lock.fallback": "Onze excuses, er is iets mis gegaan bij de poging om in te loggen.",
      ...
      "lock.network": "Server is niet bereikbaar. Check uw netwerk verbinding en probeer het nog een keer.",
      "lock.popup_closed": "Popup window gesloten. Probeer het nog een keer.",
  ...
  lastLoginInstructions: "U heeft laatst ingelogd met",
  ...
  passwordlessEmailInstructions: "Voer uw emailadres in om in te loggen<br/>of creëer een nieuwe gebruikersaccount",
  ...
  usernameFormatErrorHint: "Gebruik 1-15 letters, numbers and \"_\"",
