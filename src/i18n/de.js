export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Momentan erhalten wir mehr Anfragen, als wir gerne haben! Wenn Sie es erneut versuchen möchten, versuchen Sie es in Kürze erneut und laden Sie diese Seite erneut.'
    },
    passwordless: {
