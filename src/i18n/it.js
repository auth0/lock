export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Attualmente stiamo ricevendo più richieste di quelle con cui siamo a nostro agio! Per provare di nuovo la tua richiesta, torna tra poco e ricarica questa pagina.'
    },
    passwordless: {
