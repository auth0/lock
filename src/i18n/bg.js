...
export default {
  error: {
    ...
    login: {
      ...
      'lock.popup_closed':
        'Диалога е затворен. Моля опитайте отново.',
      ...
      invalid_captcha: 'Решете предизвикателния въпрос, за да се уверим, че не сте робот.',
  ...
  success: {
    ...
    forgotPassword: 'Току-що Ви изпратихме имейл за да възтановите паролата си.',
