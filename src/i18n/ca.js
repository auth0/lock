export default {
  error: {
    ...
    login: {
      ...
      "lock.fallback": "Hi ha hagut un error en inciar la sessió.",
  ...
  enterpriseActiveLoginInstructions: "Su us plau entreu les vostres credencials corporatives de %s.",
  failedLabel: "Error!",
  forgotPasswordTitle: "REstabliu la contrasenya",
  forgotPasswordAction: "Heu oblidat la contrasenya?",
  forgotPasswordInstructions: "Indiqueu el vostre email. Us n'enviarem les instruccions per restablir-la.",
  forgotPasswordSubmitLabel: "Enviar email",
  invalidErrorHint: "Invàlid",
  lastLoginInstructions: "L'última vegada vèreu iniciar sessió amb",
  loginAtLabel: "Iniciar a %s",
  loginLabel: "Inici cd sessió",
  ...
  submitLabel: "Envia",
  unrecoverableError: "Hi ha hagut un error.<br />Ccontacteu amb el suport tècnic.",
