...
export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Trenutno primamo više zahtjeva nego što nam je zadovoljstvo! Da biste ponovno isprobali svoj zahtjev, vratite se za kratko vrijeme i ponovo učitajte ovu stranicu.'
    },
    passwordless: {
