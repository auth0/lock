...
export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Αυτήν τη στιγμή λαμβάνουμε περισσότερα αιτήματα από αυτά που είμαστε άνετα! Για να δοκιμάσετε ξανά το αίτημά σας, επιστρέψτε σύντομα και επαναλάβετε τη φόρτωση αυτής της σελίδας.'
    },
    passwordless: {
