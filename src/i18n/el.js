export default {
  error: {
    forgotPassword: {
      ...
      enterprise_email:
        'Ο τομέας του email σας είναι μέρος ενός επιχείρματικου παρόχου ταυτοποιησης. Για να επαναφέρετε τον κωδικό πρόσβασής σας, ζητήστε το από τον διαχειριστή ασφαλείας.'
    },
    login: {
      ...
      'lock.popup_closed': 'Το κουτί διαλόγου έκλεισε. Προσπάθησε ξανά.',
      ...
      'lock.mfa_invalid_code': 'Λάθος κωδικός. Παρακαλώ προσπαθησε ξανα.',
  ...
  retryLabel: 'Δοκιμάσετε ξανα',
  sentLabel: 'Αποστάλθηκε!',
  showPassword: 'Εμφάνιση κωδικου',
  signUpTitle: 'Εγγραφή',
  signUpLabel: 'Εγγραφή',
