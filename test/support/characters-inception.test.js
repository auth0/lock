...
var normal = read(resolve(__dirname, '../../build/auth0-widget.js'));
var minified = read(resolve(__dirname, '../../build/auth0-widget.min.js'));

var altSpace = String.fromCharCode(160);
var altSpaceRegex = new RegExp(altSpace, 'g');

describe('build/auth0-widget.js', function() {
...
describe('build/auth0-widget.min.js', function() {
  it('should not have alt+space characters', function(done) {
    // they fail in chrome
